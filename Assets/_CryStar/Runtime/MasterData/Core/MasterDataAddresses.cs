...
{
    /// <summary>
    /// マスターデータのAddressable定数
    /// </summary>
    public static class MasterDataAddresses
    {
        // Labels
        public const string LABEL_RESIDENT = "master_resident";
        public const string LABEL_CACHED = "master_cached";
